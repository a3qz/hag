...
If you don't have `libncurses5-dev`, install it by doing:    
`sudo apt-get install libncurses5-dev`

Then, to play this game, you'd have to clone this repo and run:    
`make`    
`./out/hag`    
...
### Stairs:
	...
	< = go up on a staircase

	> = do down on a staircase
...
### Exit:    
	to exit, press F4 (or just Ctrl+C)
