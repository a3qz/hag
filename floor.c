                ...
                for(i = 0; i < ylen; i++){
                    for(j = 0; j < xlen; j++){
                        ...
                        if(rand()%(2000+1) <= 2*(floor_get()+5)){
                            ...
                            enemy_add(enemies, type, en.pic, en.base_hp + (((floor_get()+1))*en.base_hp)/4, i+ypos, j+xpos, en.base_sight_range, en.base_strength + rand()%(floor_get()+1), en.base_exp, en.name);
                        }
